...
public class AuthController {
    ...
    @PostMapping("/sign-up")
    public ResponseEntity<ApiResponse<Map<String, Object>>> signUp(@Validated @RequestBody SignUpRequest req) {
        auth.signUp(req);
    ...
    @PostMapping("/sign-in")
    public ResponseEntity<ApiResponse<Map<String, Object>>> signIn(@Validated @RequestBody SignInRequest req) {
